...
* [family](element__DRT2/family.md "child")

    values: DRT

    */system/coefficient/type::Function/rank::Vector/element::DRT2/family*

    Element family
    
    - DRT = Discontinuous Raviart-Thomas

* [degree](element__DRT2/degree.md "child")

    values: 0 2

    */system/coefficient/type::Function/rank::Vector/element::DRT2/degree*

    Element degree

* [enrichment](element__DRT2/enrichment.md "child")
