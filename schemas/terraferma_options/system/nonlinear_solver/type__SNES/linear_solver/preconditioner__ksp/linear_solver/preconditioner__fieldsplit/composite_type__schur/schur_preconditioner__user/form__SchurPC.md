...
* [ufl_symbol (solver)](form__SchurPC/ufl_symbol__solver "child")
    ...
    */system/nonlinear_solver/type::SNES/linear_solver/preconditioner::ksp/linear_solver/preconditioner::fieldsplit/composite_type::schur/schur_preconditioner::user/form::SchurPC/ufl_symbol::solver*
...
* [ident_zeros](form__SchurPC/ident_zeros "child")
    ...
    */system/nonlinear_solver/type::SNES/linear_solver/preconditioner::ksp/linear_solver/preconditioner::fieldsplit/composite_type::schur/schur_preconditioner::user/form::SchurPC/ident_zeros*
