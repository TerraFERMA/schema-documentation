...
* CHOICE:
    ...
    * [hypre_type](preconditioner__hypre/hypre_type "child")
        ...
        */system/nonlinear_solver/type::SNES/linear_solver/preconditioner::ksp/linear_solver/preconditioner::fieldsplit/fieldsplit/linear_solver/preconditioner::bjacobi/preconditioner::hypre/hypre_type*
